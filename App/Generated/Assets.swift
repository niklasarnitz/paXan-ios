...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let bodyDescription = ColorAsset(name: "bodyDescription")
    internal static let bodyHighlight = ColorAsset(name: "bodyHighlight")
    internal static let caption = ColorAsset(name: "caption")
    internal static let ecGreen = ColorAsset(name: "ecGreen")
    internal static let ecRed = ColorAsset(name: "ecRed")
